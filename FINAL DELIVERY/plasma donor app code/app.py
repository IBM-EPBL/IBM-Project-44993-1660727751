...
conn=ibm_db.connect("DATABASE=bludb;HOSTNAME=b1bc1829-6f45-4cd4-bef4-10cf081900bf.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=32304;UID=ljh94224;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;PWD=xyRGrmo8S5w73Q20", '','')
...
def index(usermail,subject,content):
   ...
   msg = Message(subject, sender = 'cse19.mohamedmahroof@petengg.ac.in', recipients = [usermail])
